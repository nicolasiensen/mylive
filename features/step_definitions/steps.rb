...
Then /^I should see "(.*?)" as the (\d+)[st|nd|rd] game with "(.*?)" percent completed$/ do |arg1, arg2, arg3|
  page.should have_css(".games .game:nth-child(#{arg2}) h2", :text => arg1)
  page.should have_css(".games .game:nth-child(#{arg2}) .completeness", :text => arg3)
end
